        ...
        <div className="container">
            <div className='row'>
                <div className='col-lg-6'>
                    <h1>Clients</h1>
                    <p className='p-3'>We are dedicated to diminishing our impact on the environment. We are also committed to continually improving our procedures in terms of product development, supply, packaging and distribution in an effort to minimize our environmental footprint</p>
