...
const Service = () => {
  return (
    <div className='container pt-5' data-aos="fade-up" data-aos-delay="50">
      ...
      <div className='row pt-4'>
        <div className='col-md-4'>
          ...
          <ol className='style'><span className="m-3">03 </span> Construciton Drawing and Specifications</ol>
          <ol className='style'><span className="m-3">04 </span> Cordination of Consultant Service</ol>
          <ol className='style'><span className="m-3">05 </span> Design Development</ol>
          <ol className='style'><span className="m-3">06 </span> Feasibility Studies</ol>
          <ol className='style'><span className="m-3">07 </span> 3D Perspective View & Modeling</ol>
          <ol className='style'><span className="m-3">03 </span> Landscape Design</ol>
        ...
        <h4 className='text-center'>Engineering</h4>
          ...
          <ol className='style'><span className="m-3 ">05 </span>Sub-Soil Investigaion & Analysis</ol>
          <ol className='style'><span className="m-3 ">06 </span>Seismic Analysis</ol>
          <ol className='style'><span className="m-3 ">06 </span>Structural Design & Drawings</ol>
          <ol className='style'><span className="m-3 ">06 </span>Electrical Systems Design</ol>
          <ol className='style'><span className="m-3 ">06 </span>Water & Sanitary System.</ol>
          <ol className='style'><span className="m-3 ">06 </span>Fire Protection And Life Safety</ol>
